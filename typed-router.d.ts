...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'apps-approvals-history': RouteRecordInfo<'apps-approvals-history', '/apps/approvals/history', Record<never, never>, Record<never, never>>,
    'apps-approvals-submit': RouteRecordInfo<'apps-approvals-submit', '/apps/approvals/submit', Record<never, never>, Record<never, never>>,
    'apps-approvals-view-id': RouteRecordInfo<'apps-approvals-view-id', '/apps/approvals/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
